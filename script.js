...
window.onload = () => {
    ...
    console.log(pixelBoard.children[0].style.top);
    console.log(pixelBoard.children[0].style.bottom);
    console.log(pixelBoard.children[0].style.left);
    console.log(pixelBoard.children[0].style.right);
    ...
    document.getElementById('left').addEventListener('click', function () {
        let intPosition =  (pixelBoard.children[0].style.left.substring(1, pixelBoard.children[0].style.left.length - 2));
        let position = '-' + (parseInt(intPosition)+1)+'px' ;
        pixelBoard.children[0].style.left = position;
        //pixelBoard.children[0].style.left = '-40px'
    });
    document.getElementById('right').addEventListener('click', function () {
        pixelBoard.children[0].style.left = '40px'
    });
    document.getElementById('up').addEventListener('click', function () {
        pixelBoard.children[0].style.top = '-40px'
    });
...
function pixelRowAdd(qtdRows, qtdCollums, matrizColor) {//Null - Adiciona (qtdRows*)Row  ao #pixel-board
    ...
    newBoard.style.top = '+0px';
    newBoard.style.left = '+0px';
    newBoard.style.right = '+0px';
    newBoard.style.bottom = '+0px';
